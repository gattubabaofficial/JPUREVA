  ...
  return (
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <p className="text-sm text-foreground/50">No verification requests yet.</p>
      ) : (
            ...
            <Card key={r.id}>
              <CardBody className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-xs text-foreground/50">Supplier: {r.supplier_name} · Batch {r.batch_public_id}</div>
                </div>
